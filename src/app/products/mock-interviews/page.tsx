...
// Server-side component (async data fetching)
import MockInterviewDetails from './MockInterviewDetails';
import ProductsLayout from '../layout';

// Fetch interview questions from server-side (you can replace with actual API call if needed)
...
export default async function MockInterviewsPage() {
  ...
  return (
    <ProductsLayout>
      <MockInterviewDetails interviews={interviews} />
    </ProductsLayout>
  );
}
